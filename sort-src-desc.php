...
inner join RecipeCategories on Recipes.category = RecipeCategories.category_id inner join RecipeSources on Recipes.source = RecipeSources.source_id order by RecipeSources.source_name desc, RecipeSources.source_year desc, Recipes.recipe_name asc, RecipeCategories.category_name asc"))){
